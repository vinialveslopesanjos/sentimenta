...
const brief = {
  ...
  bodyMarkdown: [
    `## ${title}`,
    "",
    "Abra com a dor concreta: o que a pessoa esta tentando decidir olhando comentarios, relatorios ou anuncios.",
    "",
    "Explique por que curtidas e alcance nao bastam para entender percepcao. Use exemplos simples, sem inventar numeros.",
    "",
    "Mostre 3 sinais observaveis nos comentarios: mudanca de tom, repeticao de temas e crescimento de emocoes negativas ou duvidas.",
    "",
    "Conecte a solucao ao Sentimenta: transformar comentarios em score, temas, emocoes e sinais de risco rastreaveis.",
    "",
    "Feche com um CTA unico para diagnostico gratuito.",
  ].join("\n"),
  adminPayload: {
    slug,
    title,
    excerpt: "Um guia pratico para transformar comentarios em decisao sem depender de achismo.",
    body_markdown: [
      `## ${title}`,
      "",
      "Abra com a dor concreta: o que a pessoa esta tentando decidir olhando comentarios, relatorios ou anuncios.",
    ...
    category: persona === "fundadores" ? "Aquisicao e Ads" : "Gestao de Reputacao",
    persona,
    tags: [persona, "comentarios", "sentimento"],
    cover_image_url: "/blog/risco-comentarios-instagram.png",
    cover_image_alt: "Capa editorial sobre comentarios e analise de sentimento",
    seo_title: title,
    seo_description: "Guia pratico do Sentimenta para transformar comentarios em decisao.",
    cta_label: "Fazer diagnostico gratuito",
    cta_href: `/diagnostico?utm_source=blog&utm_medium=organic&utm_campaign=${slug}`,
    read_time_minutes: 6,
  },
};
